  ...
  *uP, real_T *uT, real_T *Cp, real_T *Cv, real_T *K)
{
  ...
  HH1 = EP1 + TT * (0.477182 + 0.185214 * V);
  HH1 = HH1 + TT2 * ((-0.287367 - 0.0694862 * V) + TT * ((0.0742561 + 0.0164041 * V)
            + TT * ((-0.00916344 - 0.00204537 * V) + TT * EP6)));
  HH = ((3.514956 - 0.005026 * V) + TT * HH1) - ZZT * TT;
  EP6 = -FC7 / TT * ((0.000642217 - FC11) - 4.0 * FC2 * FC6 * ((1.0 + FC21) *
    (1.0 + FC21) + FC4 / FC5));
  EP6 = EP6 + (EP1 + TT * (2.0 * (0.477182 + 0.185214 * V)));
  EP6 = EP6 + TT2 * 3.0 * (-0.287367 - 0.0694862 * V);
  EP6 = EP6 + TT3 * (4.0 * (0.0742561 + 0.0164041
  ...
  *R = FC11 * ZZ;
  *h = FC11 * T * HH;
  *s = (3.5566 - 0.0659 * V) * log(T);
  *s = *s + (2.972979 + 0.55314 * V) + TT * (0.0583837 - 0.485001 * V);
  *s = *s + TT2 * ((0.871349 + 0.0698183 * V) + TT * ((-0.451556 - 0.0028772 * V)));
  *s = *s + TT4 * ((0.109164 -
    0.000693663 * V) + TT * ((0.0129754 + 9.20231E-5 * V) + TT * (0.000608234 -
    2.99679E-6 * V)));
  *s = *s - (-0.805214 + V * (-0.400981 + V * (5.76989 +
    0.060056 * V))) - log(PP);
  *s = FC11 * (*s - FC7 * FC2 * FC6 * FC8);
  *u = *h - *R * T;
