...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	ssSetDWorkWidth(S, 14, DWORK_13_WIDTH);
...
*/
   real_T *xC   = ssGetContStates(S);
    ...
    GetPTF(xC[0],xC[2],xC[1],xC[3],fs[0],300,287,2.1386e5,718.7,fs[0], 
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T *FComb = (const real_T*) ssGetInputPortSignal(S,6);
    const real_T *phi = (const real_T*) ssGetInputPortSignal(S,7);
    ...
    ThdynCVNV2Zone_Output_wrapper(FComb,phi,p,Tu,Fu,Vu,Tb,Fb,Vb,xC, 
            p_prev,Tu_prev,Fu_prev,Ru_prev,uu_prev,Cvu_prev,Tb_prev,
            Fb_prev,Rb_prev,ub_prev,Cvb_prev,mCyl_prev,mbCyl_prev,
            VCyl_prev,mu_prev,mub_prev,Vu_prev,
            QCyl_prev,HCyl_prev,WCyl_prev,mfb_prev,mMix_prev,mb0,
...
/* Function: mdlDerivatives =================================================
  ...
  static void mdlDerivatives(SimStruct *S)
  {
    ...
    ThdynCVNV2Zone_Derivatives_wrapper(dm,dmf,dV,dmfb,dQCyl,dHCyl,p,dx);
  }
