...
%    Revised:	2015.03.03	Torstein Ingebrigtsen B? Changed pmax to be an
%                                                       optional input
%    		<date>	<author> <description>
%


function [thrusters, ThrusterAllocationInverse] = thrusterInit(Thrust0, nThrusters,thruster_pos_x,thruster_pos_y,T_alpha,rotable,varargin)
...
thrusters(i).rotable = rotable(i); % true if thruster is rotable, false if fixed direction
